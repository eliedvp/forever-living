            ...
            <div className="wrap-footer-item">
              ...
              <div className="item-content">
                <div className="wrap-list-item social-network">
                  <ul>
                    <li>
                      <Link to="#" className="link-to-item" title="twitter">
                        <i className="fa fa-twitter" aria-hidden="true" />
                      </Link>
                    </li>
                    <li>
                      <Link to="#" className="link-to-item" title="facebook">
                        <i className="fa fa-facebook" aria-hidden="true" />
                      </Link>
                    </li>
                    <li>
                      <Link to="#" className="link-to-item" title="pinterest">
                        <i className="fa fa-pinterest" aria-hidden="true" />
                      </Link>
                    </li>
                    <li>
                      <Link to="#" className="link-to-item" title="instagram">
          ...
          <div className="back-link-box">
            ...
            <div className="back-link-row">
              <ul className="list-back-link">
                ...
                <li>
                  <Link to="#" className="redirect-back-link" title="mobile">
                    Mobiles
                  </Link>
                </li>
                <li>
                  <Link to="#" className="redirect-back-link" title="yphones">
                    YPhones
                  </Link>
                </li>
                <li>
